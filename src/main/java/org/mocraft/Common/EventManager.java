...
import org.mocraft.World.WorldSavedDataAok;
...
public class EventManager {
    ...
    public static WorldSavedDataAok serverDataStorage;
    ...
    public void onBlockPlaceEvent(PlayerInteractEvent e) {
        ...
        PlayerAokIEEP clientAok = PlayerAokIEEP.get(e.entityPlayer);
    ...
    public void worldLoad(WorldEvent.Load event) {
        serverDataStorage = WorldSavedDataAok.get(event.world);
    }
