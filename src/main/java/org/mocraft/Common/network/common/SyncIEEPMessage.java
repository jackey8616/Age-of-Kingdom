...
public class SyncIEEPMessage implements IMessage {
    ...
    public static class Handler extends AbstractMessageManager<SyncIEEPMessage> {
        ...
        @Override
        public IMessage handleClientMessage(EntityPlayer player, SyncIEEPMessage message, MessageContext ctx) {
        ...
        @Override
        public IMessage handleServerMessage(EntityPlayer player, SyncIEEPMessage message, MessageContext ctx) {
